(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react-dom'), require('d3-scale'), require('react'), require('d3-shape'), require('react-roughjs')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react-dom', 'd3-scale', 'react', 'd3-shape', 'react-roughjs'], factory) :
  (factory((global.roughCharts = {}),global.ReactDOM,global.d3Scale,global.react,global.d3Shape,global.reactRoughjs));
}(this, (function (exports,ReactDOM,d3Scale,React,d3Shape,reactRoughjs) {
  ...
  var XAxis = function (props) {
    ...
    return React.createElement(React.Fragment, null, React.createElement(reactRoughjs.Line, {
      ...
      options: Object.assign({}, {bowing: 0.2},
        options)
    }), ticks.map(function (t, index) { return React.createElement(React.Fragment, {
      key: index
  ...
  var ArcSeries = function (props) {
    ...
    var arcs = d3Shape.pie().startAngle(startAngleProp).padAngle(padAngleProp).endAngle(endAngleProp)(data.map(function (d) { return d[dataKey]; }));
    var arcsData = arcs.map(function (arc) {
      var startAngle = arc.startAngle;
      var endAngle = arc.endAngle;
      var padAngle = arc.padAngle;
      return {
  ...
  var CircleSeries = function (props) {
    ...
    var children = props.children;
    return React.createElement(React.Fragment, null, points.map(function (ref, index) {
      var x = ref[0];
      var y = ref[1];
  ...
  var Tooltip = function (props) {
    ...
    var renderChildren = function () {
      var text = function (s) { return React.createElement("text", {
        ref: textRef,
        textAnchor: "middle",
        stroke: "black",
        fill: "black",
  ...
  var AreaSeries = function (props) {
    ...
    var area = d3Shape.area().x(function (d) { return d.x; }).y1(function (d) { return d.y1; }).y0(function (d) { return d.y0; }).curve(curve);
  ...
  exports.Rectangle = reactRoughjs.Rectangle;
  exports.Circle = reactRoughjs.Circle;
  exports.XAxis = XAxis;
  exports.YAxis = YAxis;
